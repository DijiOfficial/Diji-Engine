...
#pragma region Ghosts
	...
	auto Blinky = scene->CreateGameObject("Blinky");
	...
	auto Pinky = scene->CreateGameObject("Pinky");
	...
	auto Inky = scene->CreateGameObject("Inky");
	...
	auto Clyde = scene->CreateGameObject("CLyde");

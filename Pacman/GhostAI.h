...
namespace pacman
{
	...
	//todo: Add blinking to ghost when frightened, add points whgen eating ghosts(probably better when all 4ghosts are there), add sound when eating ghost, make sure fright sound is continously played when ghost is frightened, adjust sppeds, pause entities when pacman eats ghost
